...
App.GetDocument().GetActiveGenericMask().SetColour(Colour(0, 255, 255))
App.GetDocument().GetGenericMaskByName("cortical").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(0, 255, 0))
App.GetDocument().GetGenericMaskByName("cancellous").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(255, 0, 255))
App.GetDocument().GetGenericMaskByName("fat").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(246, 240, 202))
App.GetDocument().GetGenericMaskByName("blood").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(0, 0, 255))
App.GetDocument().GetGenericMaskByName("air").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(0, 128, 0))
App.GetDocument().GetGenericMaskByName("csf").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(128, 0, 255))
App.GetDocument().GetGenericMaskByName("eyes").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(0, 128, 255))
App.GetDocument().GetGenericMaskByName("gm").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(255, 128, 0))
App.GetDocument().GetGenericMaskByName("wm").Activate()
App.GetDocument().GetActiveGenericMask().SetColour(Colour(255, 128, 192))
